...
public class ProfileTab extends Fragment {
    ...
    private EditText edtProfileName, edtProfileBio, edtProfilePro, edtProfileHobbies, edtProfileFavSport;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        edtProfilePro = view.findViewById(R.id.edtProfilePro);
        ...
        btnUpdateInfo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                parseUser.put("profilePro", edtProfilePro.getText().toString());
