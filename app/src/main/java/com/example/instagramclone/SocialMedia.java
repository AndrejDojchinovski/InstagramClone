            ...
            try {
                ...
                parseObject.saveInBackground(new SaveCallback() {
                    ...
                    public void done(ParseException e) {
                        if( e == null) {
                            FancyToast.makeText(SocialMedia.this,"Picture uploaded to server!", Toast.LENGTH_SHORT, FancyToast.SUCCESS,false).show();
                        } else {
                            FancyToast.makeText(SocialMedia.this,"Unknown error: " + e.getMessage(),  Toast.LENGTH_SHORT, FancyToast.ERROR,false).show();
                        }
                        dialog.dismiss();
                    }
                });
