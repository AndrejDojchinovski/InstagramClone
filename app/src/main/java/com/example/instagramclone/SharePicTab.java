...
public class SharePicTab extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        imgShare.setOnClickListener(SharePicTab.this);
    ...
    private void getChosenImage() {
       ...
       // FancyToast.makeText(getContext(), "Now we can access the images", Toast.LENGTH_SHORT, FancyToast.SUCCESS,false);

        // Accessing images of the users device
        ...
        if (requestCode == 2000) {
             if ( resultCode == Activity.RESULT_OK) {
                 ...
                 try {
                     ...
                     Cursor cursor = getActivity().getContentResolver().query(selectedImage, filePatchColumn, null, null, null);
                     cursor.moveToFirst();
